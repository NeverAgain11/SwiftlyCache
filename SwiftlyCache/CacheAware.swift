...
protocol CacheAware {
    ...
    func set(object: Value?, forKey key: String, cost: vm_size_t) -> Bool
    func set(object: Value?, forKey key: String, cost: vm_size_t, completionHandler:@escaping((_ key: String, _ finished: Bool) -> Void))
